  ...
  return (
    ...
    >
      <div className="grid gap-12 lg:grid-cols-12">
        <Reveal className="flex flex-col justify-between lg:col-span-4">
          <div>
        ...
        <div className="relative min-h-[320px] lg:col-span-8">
          <AnimatePresence mode="wait" initial={false}>
            <motion.figure
              ...
              className="relative"
            >
              <span className="font-display block select-none text-6xl leading-[0.55] text-gold/40 md:text-7xl" aria-hidden="true">&ldquo;</span>
              <blockquote className="mt-2 text-lg font-light leading-relaxed text-bone md:text-2xl md:leading-relaxed">{t.quote}</blockquote>
